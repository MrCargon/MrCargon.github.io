...
class HeaderManager {
    /**
     * Creates a new HeaderManager instance with singleton pattern
     */
    constructor() {
 // Singleton pattern - prevent multiple instances
        if (HeaderManager.instance) {
            console.warn('HeaderManager already exists, returning existing instance');
 ...
 // Event handler bindings to ensure proper 'this' context
        ...
        this._handleMobileMenuToggle = this.handleMobileMenuToggle.bind(this);
